package com.project.samplingsystem.config.permission;

import cn.hutool.core.util.ArrayUtil;
import com.project.samplingsystem.dao.repository.ResourceRepository;
import com.project.samplingsystem.exception.UnauthorizedRoleException;
import com.project.samplingsystem.exception.UserNotLoginException;
...
public class NBAuthAspect extends BaseController {
     ...
     * 权限验证切点
     */
    @Pointcut("@annotation(com.project.samplingsystem.config.permission.NBAuth)")
     ...
     * 角色验证切点
     */
    @Pointcut("@annotation(com.project.samplingsystem.config.permission.NBAuthRole)")

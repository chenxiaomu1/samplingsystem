package com.project.samplingsystem.web.management.upload;
...
public class UploadController {
    ...
    @NBAuth(value = "management:common:upload", remark = "通用上传接口", group = NBAuth.Group.AJAX)
    ...
    @NBAuth(value = "management:editormd:upload", remark = "editormd编辑器上传接口", group = NBAuth.Group.AJAX)

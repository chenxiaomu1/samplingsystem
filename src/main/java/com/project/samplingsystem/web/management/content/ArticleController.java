...
public class ArticleController extends BaseController {
    ...
    @NBAuth(value = "management:article:post_page", remark = "博文发布页面", type = NBSysResource.ResType.NAV_LINK, group = NBAuth.Group.ROUTER)
    ...
    @NBAuth(value = "management:article:list_page", remark = "博文管理页面", type = NBSysResource.ResType.NAV_LINK, group = NBAuth.Group.ROUTER)
    public String articleList() {
        return "management/content/article_list";
    }

    @RequestMapping("/article/edit")
    @NBAuth(value = "management:article:edit_page", remark = "博文管编辑页面", type = NBSysResource.ResType.OTHER, group = NBAuth.Group.ROUTER)
    ...
    @ResponseBody
    @NBAuth(value = "management:article:edit_article_tags", remark = "编辑文章页面的tag数据包含选中的(selected)", type = NBSysResource.ResType.OTHER, group = NBAuth.Group.AJAX)
    ...
    @ResponseBody
    @NBAuth(value = "management:article:update_appreciable", remark = "修改文章的可赞赏状态", group = NBAuth.Group.AJAX)
    ...
    @ResponseBody
    @NBAuth(value = "management:article:update_commented", remark = "修改文章的可评论状态", group = NBAuth.Group.AJAX)
    ...
    @ResponseBody
    @NBAuth(value = "management:article:update_top", remark = "修改文章的置顶状态", group = NBAuth.Group.AJAX)
    ...
    @ResponseBody
    @NBAuth(value = "management:article:delete", remark = "删除文章操作", group = NBAuth.Group.AJAX)
